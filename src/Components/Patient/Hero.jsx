...
<div className="patientName">
               <h1>Patient:<span className='name'>Mr.Anthony Yakhni</span></h1>
               </div>
<div className="hero">
...
<div className="hero1">
    ...
    <h5>Birthdate: 10/28/1999</h5>
    <h5>Sex: Male</h5>
    <h5>Address: 305 Plains</h5>
    <h5>Phone#: 905-321-9876</h5>
    <h5>Family Doctor: Dr.Sonia Masood</h5>
    <h5>Blood Type: B+</h5>
    <h5>Ethnicity: lebanese</h5>
    <h5>Allergies: N/A</h5>
